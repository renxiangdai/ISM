...
if __name__ == "__main__":
    ...
    parser.add_argument("--depth_path", default="/data/rxdai/Instance_Segmentation_Model/ceshi/depth.png", help="Path to Depth image(mm)")
    parser.add_argument("--cam_path", default="/data/rxdai/Instance_Segmentation_Model/ceshi/camera.json", help="Path to camera information")
